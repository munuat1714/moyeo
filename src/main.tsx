...
import {
  ...
  Bell, BusFront, Clock3, Coffee, Compass, Copy, ExternalLink, Footprints, Home, Map, MapPin, Plus,
  RotateCcw, ShieldCheck, Sparkles, TrainFront, Trash2,
...
if (typeof document !== 'undefined') {
  ...
  if (root) createRoot(root).render(<React.StrictMode><App mode="demo" /></React.StrictMode>)
}
